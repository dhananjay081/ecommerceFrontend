...
export const CATEGORYWISE_PRODUCT_REQUEST = 'CATEGORYWISE_PRODUCT_REQUEST';
export const CATEGORYWISE_PRODUCT_SUCCESS = 'CATEGORYWISE_PRODUCT_SUCCESS';
export const CATEGORYWISE_PRODUCT_FAIL = 'CATEGORYWISE_PRODUCT_FAIL';
export const CATEGORYWISE_PRODUCT_RESET = 'CATEGORYWISE_PRODUCT_RESET';
